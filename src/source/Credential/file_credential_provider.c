 ...
 * FUNCTIONS
 ******************************************************************************/
static STATUS getFileCredentials(PAwsCredentialProvider, PAwsCredentials*);
static STATUS readFileCredentials(PFileCredentialProvider);
...
static STATUS getFileCredentials(PAwsCredentialProvider pCredentialProvider, PAwsCredentials* ppAwsCredentials)
{
    ENTERS();
...
static STATUS readFileCredentials(PFileCredentialProvider pFileCredentialProvider)
{
    STATUS retStatus = STATUS_SUCCESS;
    UINT64 fileLen;
    FILE* fp = NULL;
